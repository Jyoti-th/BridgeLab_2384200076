...
class Program
{
    static void Main()
    {
        // Create a regular student object with new names
        Student student1 = new Student(235, "John Doe", 8.3);
        ...
        // Create a postgraduate student object with new names
        PostgraduateStudent pgStudent = new PostgraduateStudent(262, "Jane Smith", 7.0);
