...
class Program
{
    static void Main()
    {
        // Creating a regular Book object with new names
        Book book1 = new Book("978-3-16-148410-0", "1984", "George Orwell");
        ...
        // Creating an EBook object with new names
        EBook eBook1 = new EBook("978-1-23-456789-0", "Digital Marketing 101", "Emily Johnson");
        eBook1.DisplayEBookDetails();

        // Modify the author's name using SetAuthor for the EBook
        eBook1.SetAuthor("Sophia Brown");
