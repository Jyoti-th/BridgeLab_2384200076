...
class Program
{
    static void Main()
    {
        // Create a regular BankAccount object with new names
        BankAccount account1 = new BankAccount("123456789", "Joe Dalton", 5000000);
        ...
        // Create a SavingsAccount object with new names
        SavingsAccount savingsAccount1 = new SavingsAccount("987654321", "Jerry Smith", 1000000);
